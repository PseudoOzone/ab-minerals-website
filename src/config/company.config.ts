...
export const benchmarkProjects = [
  {
    ...
    type: "Airport",
    status: "Completed",
    description: "Premium granite flooring and wall cladding for terminal areas.",
    image: "/projects/bangalore-airport.jpg",  // ← PLACEHOLDER: Add image
    stoneUsed: ["Lavender Blue", "Star White"],
    quantity: "50,000+ sqft",
  },
  {
    id: "igi-delhi-airport",
    name: "IGI Delhi Airport",
    type: "Airport",
    status: "Completed",
    description: "High-traffic flooring solutions for international terminal.",
    image: "/projects/delhi-airport.jpg",      // ← PLACEHOLDER: Add image
    stoneUsed: ["SK Blue", "Ikon Brown"],
  ...
  },
  {
    ...
    type: "Metro Rail",
    status: "Ongoing",
    description: "Station flooring and platform cladding for multiple stations.",
    image: "/projects/pune-metro.jpg",         // ← PLACEHOLDER: Add image
