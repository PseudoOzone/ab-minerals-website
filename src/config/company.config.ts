...
export const leadership = [
  ...
  {
    id: "plant-head",
    name: "Jagannath Biswal",
    fullName: "Jagannath Biswal",
    role: "Plant & Operations Head",
    bio: "Jagannath Biswal leads all plant operations at A B Minerals' Chamakhandi factory. He oversees day-to-day production across gang saws, block cutters, and the 12-head polishing line — ensuring consistent output quality and on-time dispatch for projects across India.",
    shortBio: "Factory floor to dispatch — ensuring quality at every step.",
    image: "",
    experience: "Industry veteran",
    expertise: [
  ...
  {
    id: "accounts-head",
    name: "Prashanta Behra",
    fullName: "Prashanta Behra",
    role: "Accounts Head",
    bio: "Prashanta Behra manages all financial operations at A B Minerals, including accounts, invoicing, taxation, and compliance. His meticulous approach ensures smooth financial workflows — from purchase orders and vendor payments to project billing and statutory filings.",
    shortBio: "Keeping the numbers sharp and the books clean.",
    image: "/team/prashanta-behra.jpg",
    experience: "Industry veteran",
    expertise: [
...
export const seoDefaults = {
  ...
  keywords: [
    ...
    "A B Minerals", "AB Minerals", "ABM", "A.B. Minerals",
    "A B Mineral", "AB Mineral", "Ab Minerals",
    // Product
    "granite slabs", "premium granite",
    "lavender blue granite", "lavender blue granite price",
    "lavender blue granite supplier",
    // Product misspellings
    "lavendar blue granite", "lavander blue granite",
    "lavender blu granite", "lavendor blue granite",
    // Other stones
    "sk blue granite", "ikon brown granite", "star white granite",
    // Generic
    "granite supplier india", "granite exporter india", "odisha granite",
    "building granite", "project granite", "granite quarry owner",
    "granite manufacturer", "blue granite india", "granite factory odisha",
    "granite for airports", "granite for metro stations",
    "granite for hospitals", "bulk granite supplier",
    "granite export", "granite slabs wholesale",
  ],
