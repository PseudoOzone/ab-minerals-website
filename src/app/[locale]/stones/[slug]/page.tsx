...
// Generate static params for all stone slugs × all locales
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string; slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    keywords,
    alternates: {
      canonical: `https://www.abminerals.com/${locale}/stones/${stone.slug}`,
    },
    openGraph: {
      ...
      url: `https://www.abminerals.com/${locale}/stones/${stone.slug}`,
...
export default async function StonePage({ params }: { params: Promise<{ locale: string; slug: string }> }) {
