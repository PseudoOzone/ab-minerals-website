...
export function StoneDetailClient({ params }: PageProps) {
  const t = useTranslations('stoneDetail');
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            >
              ...
              <motion.span 
                ...
                style={{ color: '#C9A962' }}
              >
                {tc('collection', { category: stone.priceCategory })}
              </motion.span>
              ...
              <motion.div variants={fadeInUp} className="mb-8 flex items-center gap-2">
                {stone.inStock ? (
                  <>
                    ...
                    <span style={{ color: '#A0A0A0' }}>{tc('readyForDispatch')}</span>
                  </>
                ) : (
                  <>
                    <span className="w-2 h-2 rounded-full bg-yellow-500" />
                    <span style={{ color: '#A0A0A0' }}>{tc('limitedAvailability')}</span>
                  </>
                )}
              </motion.div>
          ...
          >
            {prevStone ? (
              ...
              >
                ...
                <div>
                  <span className="text-xs uppercase tracking-wider block" style={{ color: '#666' }}>{tc('previous')}</span>
            ...
            {nextStone ? (
              ...
              >
                <div>
                  <span className="text-xs uppercase tracking-wider block" style={{ color: '#666' }}>{tc('next')}</span>
