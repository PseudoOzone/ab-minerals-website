          ...
          <RevealOnScroll>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div className="text-center group">
                ...
                <Text muted>{t('statCapacity', { unit: companyInfo.stats.capacityUnit })}</Text>
                <div 
                  className="mt-4 w-12 h-px mx-auto transition-all duration-500 group-hover:w-20"
                  style={{ backgroundColor: 'rgba(201, 169, 98, 0.3)' }}
                />
              ...
              <div className="text-center group">
                ...
                <Text muted>{t('statProjects')}</Text>
                <div 
                  className="mt-4 w-12 h-px mx-auto transition-all duration-500 group-hover:w-20"
                  style={{ backgroundColor: 'rgba(201, 169, 98, 0.3)' }}
                />
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              >
                <span className="text-sm font-medium" style={{ color: '#C9A962' }}>{t('our_quarry')}</span>
              </div>
            </motion.div>
