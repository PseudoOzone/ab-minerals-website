            ...
            >
              ...
              <motion.div variants={fadeInUp} className="text-center">
                <h1 className="font-serif font-medium tracking-tight text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl mb-4 sm:mb-6">
                  <span style={{ color: '#B8860B' }}>{t('heroTitle1')}</span>
                  <br />
                  <span className="text-[#e0e0e0] sm:text-[#1a1a2e]">{t('heroTitle2')}</span>
                  <br />
                  <span className="text-[#e0e0e0] sm:text-[#1a1a2e]">{t('heroTitle3')}</span>
                </h1>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} className="text-center">
                <p className="text-sm sm:text-base md:text-lg mb-6 sm:mb-10 max-w-xl mx-auto font-medium text-[#e0e0e0] sm:text-[#2d2d44]">
                  ...
                  <span className="hidden sm:inline">{t('heroSubtextDesktop')}</span>
                  <span className="sm:hidden">{t('heroSubtextMobile')}</span>
                </p>
              </motion.div>
          ...
          >
            <motion.div variants={fadeInUp}>
              <SectionHeader
                ...
                title={t('stonesTitle')}
                description={t('stonesDescription')}
              />
            </motion.div>
                    ...
                    >
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6">
                        ...
                        <div 
                          ...
                          style={{ color: '#C9A962' }}
                        >
                          <span className="text-sm">{tc('viewDetails')}</span>
          ...
          >
            <motion.div variants={fadeInUp}>
              <SectionHeader
                ...
                description={t('capabilitiesDescription', { capacity: companyInfo.stats.monthlyCapacity, unit: companyInfo.stats.capacityUnit })}
              />
            </motion.div>
          ...
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <h2 
                ...
                style={{ color: '#F5F5F0' }}
              >
                <AnimatedWords text={t('advantage')} />
              </h2>
              <p 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                title: t('panIndiaTitle'),
                description: t('panIndiaDesc')
              }
            ].map((item, index) => (
            ...
            <div className="text-center relative z-10">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm" style={{ color: 'rgba(245, 245, 240, 0.5)' }}>{t('quickResponse')}</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#C9A962' }} />
                  <span className="text-sm" style={{ color: 'rgba(245, 245, 240, 0.5)' }}>{t('sampleKits')}</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#C9A962' }} />
                  <span className="text-sm" style={{ color: 'rgba(245, 245, 240, 0.5)' }}>{t('panIndiaDelivery')}</span>
                </div>
              </motion.div>
            </div>
          </RevealOnScroll>
