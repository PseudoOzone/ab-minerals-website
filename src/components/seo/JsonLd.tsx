...
export function OrganizationJsonLd() {
  const schema = {
    ...
    alternateName: [
      'AB Minerals', 'A B Minerals', 'ABM', 'AB Minerals Pvt Ltd',
      'A B Minerals Private Limited', 'AB Minerals Private Limited',
      'A.B. Minerals', 'A B Mineral', 'AB Mineral',
      'Ab Minerals', 'ab minerals', 'a b minerals',
    ],
...
export function LocalBusinessJsonLd() {
  const schema = {
    ...
    knowsAbout: [
      'granite', 'Lavender Blue granite', 'granite quarrying', 'granite processing', 'stone fabrication',
...
export function WebSiteJsonLd() {
  const schema = {
    ...
    alternateName: [
      'AB Minerals', 'A B Minerals', 'ABM',
      'A.B. Minerals', 'Ab Minerals', 'AB Mineral',
    ],
    url: 'https://www.abminerals.com',
    inLanguage: 'en-IN',
